...
$stmt = $pdo->query("SELECT educacion_1 as educacion from talleres GROUP BY educacion_1", PDO::FETCH_ASSOC);
...
$stmt = $pdo->query("SELECT MAX(nro_trabajadores) as trabajadoress from talleres ", PDO::FETCH_ASSOC);
